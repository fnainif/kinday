...
class _HomepageState extends State<Homepage> {
  // Declare a TaskCard object to represent the suggested task
  TaskCard? _suggestedTask;

  @override
  void initState() {
    super.initState();
    // Initialize with a sample suggested task.
    // In a real app, this would come from your task list or a recommendation logic.
    _suggestedTask = TaskCard(
      title: "Membuat Presentasi",
      description: "Persiapan untuk presentasi besok pagi",
      energylvl: 3, // Example energy level
      prioritytask: 2, // Example priority
    );
  }
                              ...
                              Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        // Display title from _suggestedTask
                                      ...
                                      // You can add more details from _suggestedTask here if needed
                                    ],
                                  ),
                                ],
                              ),
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  if (_suggestedTask != null) {
                                    // Correctly assign the TaskCard object
