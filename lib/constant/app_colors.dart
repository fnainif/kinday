...
class AppColors {
  ...
  static final ValueNotifier<String> themeNotifier = ValueNotifier<String>("Lavender Dreams");

  static void init() {
    themeNotifier.value = PreferenceHandler.theme;
  }

  static AppThemeData get currentTheme => themes[themeNotifier.value] ?? themes["Lavender Dreams"]!;
